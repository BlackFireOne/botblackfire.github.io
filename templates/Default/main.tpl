...
[/logged]
 ...
 <div>ViiEngine-Rus &copy; {dategod} <a class="cursor_pointer" onClick="translate.box()" onMouseOver="myhtml.title('1', 'Выбор используемого языка на сайте', 'langTitle', 1)" id="langTitle1">{lang}</a></div>
