...
<div style="margin-left: 155px;margin-top: -175px;z-index:10;position:absolute; ">{user_znachok}</div>
...
<a href="/" onClick="Profile.LoadPhoto(); return false;"><img class="icon addfr_fan" src="{theme}/images/fre.png" alt="" /><div>Изменить фотографию</div></a>
<a href="/" onClick="Profile.miniature(); return false;"><img class="icon addfr_fan" src="{theme}/images/minn.png" alt="" /><div>Изменить миниатюру</div></a>
<a href="/" onClick="Profile.DelPhoto(); return false;" id="del_pho_but" {display-ava}><img class="icon addfr_fan" src="{theme}/images/dekk.png" alt="" /><div>Удалить фотографию</div></a>


<a href="/" onClick="im_chat.chatOpen(); return false"><img class="icon addfr_fan"src="{theme}/images/mes.png"/><div>Диалоги</div></a>
<a href="#" onclick="doLoad.data(1); fon.addbox()">   <img class="icon addfr_fan"src="{theme}/images/fan.png"/>   <div>Фон</div>    </a>
<a href="/" onClick="znachok.box({user-id},1); return false"><img class="icon addfr_fan"src="{theme}/images/zna.png" alt="" /><div>Прикрепить значок</div></a>
...
[not-owner][blacklist][privacy-msg]<a href="/" onClick="messages.new_({user-id}); return false"><img class="icon addfr_fan" src="{theme}/images/pmm.png" alt="" /><div>Отправить сообщение</div></a>[/privacy-msg][/blacklist]
[no-friends][blacklist]<a href="/" onClick="friends.add({user-id}); return false"><img class="icon addfr_fan" src="{theme}/images/addf.png" alt="" /><div>Добавить в друзья</div></a>[/blacklist][/no-friends]
[yes-friends]<a href="/" onClick="friends.delet({user-id}, 1); return false"><img class="icon addfr_fan" src="{theme}/images/delf.png" alt="" /><div>Убрать из друзей</div></a>[/yes-friends]
[blacklist][no-subscription]<a href="/" onClick="subscriptions.add({user-id}); return false" id="lnk_unsubscription"><img class="icon addfr_fan" src="{theme}/images/obn.png" alt="" /><div><span id="text_add_subscription">Подписаться на обновления</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addsubscription_load" class="no_display" style="margin-right:-13px" /></div></a>[/no-subscription][/blacklist]
[yes-subscription]<a href="/" onClick="subscriptions.del({user-id}); return false" id="lnk_unsubscription"><img class="icon addfr_fan" src="{theme}/images/dobn.png" alt="" /><div><span id="text_add_subscription">Отписаться от обновлений</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addsubscription_load" class="no_display" style="margin-right:-13px" /></div></a>[/yes-subscription]
<a href="/" onClick="giftWindow.giftsList('{user-id}'); return false"><img class="icon addfr_fan" src="{theme}/images/giftt.png" alt="" /><div>Отправить подарок</div></a>
[no-fave]<a href="/" onClick="fave.add({user-id}); return false" id="addfave_but"><img class="icon addfr_fan" src="{theme}/images/zakl.png" alt="" /><div><span id="text_add_fave">Добавить в закладки</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/no-fave]
[yes-fave]<a href="/" onClick="fave.delet({user-id}); return false" id="addfave_but"><img class="icon addfr_fan" src="{theme}/images/delzakl.png" alt="" /><div><span id="text_add_fave">Удалить из закладок</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/yes-fave]
[no-blacklist]<a href="/" onClick="settings.addblacklist({user-id}); return false" id="addblacklist_but"><img class="icon addfr_fan" src="{theme}/images/blok.png" alt="" /><div><span id="text_add_blacklist">Заблокировать</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load" class="no_display" /></div></a>[/no-blacklist]
[yes-blacklist]<a href="/" onClick="settings.delblacklist({user-id}, 1); return false" id="addblacklist_but"><img class="icon addfr_fan" src="{theme}/images/pazblok.png" alt="" /><div><span id="text_add_blacklist">Разблокировать</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load" class="no_display" /></div></a>[/yes-blacklist]
[/not-owner]
</div>
...
[online-friends]<a href="/friends/online/{user-id}" style="text-decoration:none" onClick="Page.Go(this.href); return false"><div class="albtitle">Друзья на сайте <span>{online-friends-num}</span></div></a>
 ...
 [subscriptions]<a href="/" onClick="subscriptions.all({user-id}, '', {subscriptions-num}); return false" style="text-decoration:none"><div class="albtitle">Интересные персоны <span>{subscriptions-num}</span></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{subscriptions}<div class="clear"></div>
 </div>[/subscriptions]
 
 
 
[privacy-public][groups]<div class="albtitle cursor_pointer" onClick="groups.all_groups_user('{user-id}')">Сообщества <span id="groups_num">{groups-num}</span></div>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{groups}<div class="clear"></div>
 </div>[/groups][/privacy-public]
 
 

[privacy-video][videos]<a href="/videos/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">Видеозаписи <span>{videos-num}</span></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{videos}<div class="clear"></div>
 </div>[/videos][/privacy-video]
 
 
 
[privacy-notes][notes]<a href="/notes/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">Заметки <span>{notes-num}</span></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-left:5px">{notes}<div class="clear"></div>
 </div>[/notes][/privacy-notes]
...
<div class="profiewr">
 ...
 <div class="titleu">{name} {lastname}          <span class="profile_online_green">{online}</span>       </div> 
 <div class="status">
 ...
 [blacklist][not-all-birthday]<div class="flpodtext">Знак зодиака:</div> <div class="flpodinfo"><a>{zodiak}</a></div>[/not-all-birthday]
...
[privacy-audio][audios]<div id="jquery_jplayer"></div><input type="hidden" id="teck_id" value="1" /><a href="/audio{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:5px">{audios-num}<div><b>Все</b></div></div></a>{audios}<div class="clear"></div>[/audios][/privacy-audio]
 
 
 
[privacy-gift][gifts]<a href="/gifts{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:5px">{gifts-text}<div><b>Все</b></div></div><center>{gifts}</center><div class="clear"></div></a>[/gifts][/privacy-gift]
...
</div><div class="autowr" style="padding-right: 439.5px; padding-left: 439.5px;">{url_img}</div>
<div class="clear"></div>